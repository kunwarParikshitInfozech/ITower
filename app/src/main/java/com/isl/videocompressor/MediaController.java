package com.isl.videocompressor;
...
public class MediaController {
    ...
    @TargetApi(16)
    public File convertVideo(final String path,String name) {
        ...
        /*File cacheFile = new File(
                Environment.getExternalStorageDirectory()
                        + File.separator
                        + AppConstants.VIDEO_COMPRESSOR_APPLICATION_DIR_NAME
                        + AppConstants.VIDEO_COMPRESSOR_COMPRESSED_VIDEOS_DIR,name
        );*/
