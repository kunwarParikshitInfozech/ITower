            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
                ...
                String pending_tab_rights = db.getSubMenuRight( "Pending", "Preventive" );
                  if (pending_tab_rights.contains("A")) {
                    Intent i = new Intent( getActivity(), PMChecklistApproval.class);
    ...
    private class CheckListDetailsTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            if (PMCheckListDetails == null) {
                ...
                dbHelper.insertReviewerCheckList(PMCheckListDetails.getPMCheckListDetail(),activityId,txnId,getActivity(),temp_flag);
                dbHelper.close();
            } else {
