...
public class ScheduleFragement extends Fragment {
                        ...
                        if (getContext().getPackageName().equalsIgnoreCase("tawal.com.sa")) {
                            if (Utils.isNetworkAvailable(getContext())) {
                                callGetApiRespnce(response_ticket_list.getSite_list().get(selectedPos).getSITE_ID(),
                                        response_ticket_list.getSite_list().get(selectedPos).getPARAM_ID(), selectedPos, alreadyJson);
                            }
                        } else {
                            activity(selectedPos, alreadyJson);
                        }
                    }
                }
                db.close();
    ...
    private void callGetApiRespnce(String site_id, String activtyTypeId, int selectedPos, int alreadyJson) {
