...
/**
 * Created by dhakan on 6/9/2020.
 */

public class DropDownView implements AdapterView.OnItemSelectedListener {

    public static HashMap<String, String> prvValues;

    AppPreferences mAppPreferences = new AppPreferences( MyApp.getAppContext());

    public DropDownView(HashMap<String, String> prvValues){
        DropDownView.prvValues = prvValues;
    }
    ...
    public Spinner addSpinner(Context context, FormControl formControl) {
        ...
        if(AppConstants.DROPDOWN_VAL_TYPE.SQL.getValue() == formControl.getDropDownValType() && sql!=null){
            ...
            if(formControl.getKeyItem().equalsIgnoreCase( AppConstants.CIRCLE_ID_ALIAS )) {
                ...
                sql= UtilsTask.getClusterSql(sql,mAppPreferences.getCircleID(),mAppPreferences.getZoneID(),mAppPreferences.getClusterID());
        ...
        spinner.setOnItemSelectedListener( DropDownView.this);
    ...
    public void onItemSelected(AdapterView<?> arg0, View arg1, int position, long arg3) {
        ...
        if (AppConstants.FIELD_TYPE.READ_WRITE.getValue() == formControl.getFieldType()){
            ...
            String selectId = "-1";
            String selectValue = formControl.getSpinner().getSelectedItem().toString().trim();
            ...
            if (AppConstants.DROPDOWN_VAL_TYPE.SQL.getValue() == formControl.getDropDownValType()
                    && formControl.getChangeReload() != null) {
