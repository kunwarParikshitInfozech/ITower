...
public class SearchableSpinner extends androidx.appcompat.widget.AppCompatSpinner implements View.OnTouchListener,
    ...
    private void init() {
        ...
        if (!TextUtils.isEmpty(_strHintText)) {
            //ArrayAdapter arrayAdapter = new ArrayAdapter(_context,R.layout.spinner_text, new String[]{
            ArrayAdapter arrayAdapter = new ArrayAdapter(_context, android.R.layout.simple_list_item_1, new String[]{
                    _strHintText
            });
            _isFromInit = true;
