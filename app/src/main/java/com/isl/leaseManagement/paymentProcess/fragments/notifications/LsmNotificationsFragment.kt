package com.isl.leaseManagement.paymentProcess.fragments.notifications
...
import com.isl.leaseManagement.paymentProcess.adapters.NotificationListAdapter
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            db?.notificationDao()?.allNotifications?.let { notificaionList ->
                ...
                withContext(Dispatchers.Main){
                    notificationListAdapter = NotificationListAdapter(context,notificationListTmp.toList());
