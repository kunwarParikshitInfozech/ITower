...
import com.isl.leaseManagement.paymentProcess.adapters.DeleteDocumentAdapter
...
class AddAdditionalDocumentActivity : BaseActivity() {
    ...
    private lateinit var viewModel: com.isl.leaseManagement.paymentProcess.activities.addAdditionalDoc.AddAdditionalDocumentViewModel
    ...
    private fun init() {
        ...
        val factory =
            com.isl.leaseManagement.paymentProcess.activities.addAdditionalDoc.AddAdditionalDocumentViewModelFactory(
                com.isl.leaseManagement.paymentProcess.activities.addAdditionalDoc.AddAdditionalDocumentRepository()
            )
        viewModel = ViewModelProvider(this, factory)[com.isl.leaseManagement.paymentProcess.activities.addAdditionalDoc.AddAdditionalDocumentViewModel::class.java]
        setClickListeners()
    }
