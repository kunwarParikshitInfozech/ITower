...
object AppConstants {
    ...
    object IntentKeys {
        ...
        const val autoGeneratedId = "AutoGeneratedId"
        const val candidateRejectionRemarks = "CandidateRejectionRemarks"
        const val candidateOrLandlordName = "CandidateOrLandlordName"
    ...
    object DropDownParamTypes {
        const val areaType = "AreaType"
        const val leasedSpaceType = "LeasedSpaceType"
        const val siteType = "SiteType"
        const val accessRoad = "AccessRoad"
        const val powerSourceType = "PowerSourceType"
        const val landlordType = "LandlordType"
        const val countryName = "CountryName"
        const val governmentType = "GovernmentType"
        const val vatPercentageType = "VATPercentageType"
        const val taxOrganizationType = "TaxOrganizationType"
        const val delegateRolesType = "DelegateRolesType"
        const val paymentMethodType = "PaymentMethodType"
        const val bankName = "BankName"
        const val bankBranchName = "BankBranchName"
        const val currencyType = "CurrencyType"
    }
}