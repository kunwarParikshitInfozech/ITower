...
class ExistingCandidateListResponse :
    ...
    data class ExistingCandidateListResponseItem(
        @PrimaryKey(autoGenerate = true) val autoGeneratedId: Int = 0, //for room unique identification,not from api, used in mapping property details, landlord details etc.. no need of property id for mapping
        var taskId: Int,   // for room for separating current task captured candidates from all others
        val _Id: Int?,
