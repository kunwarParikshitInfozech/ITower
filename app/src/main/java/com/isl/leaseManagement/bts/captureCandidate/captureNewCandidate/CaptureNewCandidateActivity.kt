...
class CaptureNewCandidateActivity : BaseActivity() {
    ...
    private var candidateOrLandlordName = ""
    ...
    private fun checkIfNewCandidateOrExisting() {
        ...
        candidateName?.let {
            binding.captureCandidateTv.text = it
            candidateOrLandlordName = it
            binding.captureCandidateTv.text = it
        }
    ...
    private var isNewCandidate = true
    private fun setClickListeners() {
        ...
        binding.propertyDetails.setOnClickListener {
            ...
            if (isNewCandidate) {  // closing as new data is received by existing candidate captured list, not from any new property or landlord
                finish()
