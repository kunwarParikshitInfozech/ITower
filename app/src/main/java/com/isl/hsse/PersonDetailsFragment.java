...
public class PersonDetailsFragment extends Fragment {
    ...
    private void initialize(){
        ...
        bt_add_person.setVisibility(View.VISIBLE);
        ...
        bt_add_person.setText("Add Person Details ");
        try {
            maxCount = Integer.parseInt(Utils.msg( getActivity(), "717" ));
        }catch (Exception e) {
            maxCount = 5;
        }
        ...
        bt_add_person.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                if(tranData.get(Constants.PROCESS_INSTANCE_ID)!=null
                    ...
                    Utils.toastMsg(getActivity(),
                            "Please first add HSSE Ticket before adding PersonDetails.");
                }else if(requestList!= null && requestList.size()>=maxCount){
                    Utils.toastMsg(getActivity(),
                            "Maximum " +maxCount+ " Person details  can be added.");
                }else {
                    if (getActivity().getIntent().getExtras() != null) {
                        tranData.put( Constants.FORM_KEY, "AddHSSEPersonalDetail" );
    ...
    public class GetRequestList extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("subTabName", "pd"));
        ...
        protected void onPostExecute(Void result) {
           if (requestList == null) {
                ...
                msgLayout.setVisibility(View.GONE);
                datLayout.setVisibility(View.VISIBLE);
                rvList.setAdapter( new SubTabAdapter(getActivity(),requestList,tranData,"PersonDetails",editRight));
            } else {
                msgLayout.setVisibility(View.VISIBLE);
                datLayout.setVisibility(View.GONE);
