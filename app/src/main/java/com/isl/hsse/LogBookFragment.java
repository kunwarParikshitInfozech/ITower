...
public class LogBookFragment extends Fragment {
    ...
    private void initialize(){
        ...
        bt_add_logbook.setVisibility(View.VISIBLE);
        ...
        try {
            maxCount = Integer.parseInt(Utils.msg( getActivity(), "718" ));
        }catch (Exception e) {
            maxCount = 7;
        }

        bt_add_logbook.setText("Add LogBook Details ");
        ...
        bt_add_logbook.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v) {
               ...
               Utils.toastMsg(getActivity(),
                           "Please first add HSSE Ticket before adding LogBook Details.");
               }else if(requestList!= null && requestList.size()>=maxCount){
                   Utils.toastMsg(getActivity(),
                           "Maximum " +maxCount+ " LogBook Details  can be added.");
               }else {
                    if (getActivity().getIntent().getExtras() != null) {
                        tranData.put( Constants.FORM_KEY, "AddHSSELogBook" );
    ...
    public class GetRequestList extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                nameValuePairs.add(new BasicNameValuePair("subTabName", "lb"));
        ...
        protected void onPostExecute(Void result) {
            if (requestList == null) {
                ...
                msgLayout.setVisibility(View.GONE);
                datLayout.setVisibility(View.VISIBLE);
                rvList.setAdapter( new SubTabAdapter(getActivity(),requestList,tranData,"LogBook",editRight));
            } else {
                msgLayout.setVisibility(View.VISIBLE);
                datLayout.setVisibility(View.GONE);
